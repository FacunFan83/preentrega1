...
import { productsData } from './createJSON.js'
...
export class ProductManajer {
    ...
    async init() {
        ...
        try {
            ...
            await this.#createfile() // Ejecuta el metodo para la creación del archivo 
        }}
    ...
    /**
     * Crea a partir de la plantilla de productos, el contenido del archivo products.json
     */
    async #createfile() {
